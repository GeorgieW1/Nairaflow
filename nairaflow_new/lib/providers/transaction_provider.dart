...
import 'package:nairaflow_new/services/transaction_service.dart';
...
class TransactionNotifier extends StateNotifier<TransactionState> {
  ...
  Future<void> subscribeTVService({
    ...
    state = state.copyWith(isLoading: true, error: null);
    try {
      final transaction = await TransactionService.subscribeTV(
  ...
  Future<void> purchaseEpin({
    ...
    state = state.copyWith(isLoading: true, error: null);
    try {
      final transaction = await TransactionService.purchaseEpin(
        category: category,
        quantity: quantity,
        amount: amount,
        phone: phone,
